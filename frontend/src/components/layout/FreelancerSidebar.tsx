...
const mainItems = [
  ...
  { title: "My Projects", url: "/freelancer/projects", icon: FolderKanban },
  { title: "Deliverables", url: "/freelancer/deliverables", icon: Upload },
];

const secondaryItems = [
  { title: "Notifications", url: "/freelancer/notifications", icon: Bell },
